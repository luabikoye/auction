                                ...
                                <form method="post" action="proc-change-password.php" class="form-horizontal form-material">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="old_password" type="password"  value="<?php echo $old_password ;?>" class="form-control p-0 border-0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="new_password" type="password"  value="<?php echo $new_password ;?>" class="form-control p-0 border-0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="confirm_password" type="password"  value="<?php echo $confirm_password ;?>" class="form-control p-0 border-0">
                                        </div>
                                    </div>
