                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="description" type="text" style="width: 400px;" value="<?php echo $description ;?>" class="form-control p-0 border-0">
                                        </div>
                                </div>
                                <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Image</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="image" type="file" style="width: 250px;" value="<?php echo $image ;?>" class="form-control p-0 border-0">
                                        </div>
                                </div>
                                <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Deadline</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="deadline" type="datetime-local" style="width: 250px;"  value="<?php echo $deadline ;?>" class="form-control p-0 border-0">
                                        </div>
                                </div>
